                    ...
                    <td>
                        ...
                        <form
                            ...
                            <div class="modal fade" id="delete{{ $especializacaoprofissional->id }}" tabindex="-1"
                                 role="dialog"
                                 aria-labelledby="deleteModalLabel{{ $especializacaoprofissional->id }}"
                                 aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title"
                                                id="deleteModalLabel{{ $especializacaoprofissional->id }}">Confirmação
                                                de
                                                Exclusão</h5>
                                        </div>
                                        <div class="modal-body">
                                            <p>Deseja realmente excluir a especializacao
                                                '{{ $especializacaoprofissional->especializacoes->descricao_especializacao}}
                                                '?</p>
                                        </div>
