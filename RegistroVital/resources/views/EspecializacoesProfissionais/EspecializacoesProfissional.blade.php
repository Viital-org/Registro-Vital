...
<form action="{{ route('especializacao-profissional-store') }}" method="POST">
        ...
        <div class="input-group mb-3">
            <button class="btn btn-outline-secondary" type="button" id="button-addon1" data-bs-toggle="modal"
                    data-bs-target="#enderecoModal">Definir endereço
            </button>
            <input type="text" class="form-control" id="endereco" name="endereco" aria-describedby="button-addon1"
                   readonly placeholder="Endereço de atendimento">
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="enviar">Enviar
                        </button>
                    </div>
                </div>
            </div>
