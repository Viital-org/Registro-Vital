...
@section('conteudo')
    ...
    <a href="/cadastroanotacoes" class="btn btn-outline-info">Cadastrar nova anotacao</a>

    <h1>Anotacoes realizadas</h1>
    <br>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th scope="col">Tipo de anotacao</th>
            <th scope="col">Anotacao</th>
            <th scope="col">Data da anotacao</th>
